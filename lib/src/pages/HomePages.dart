...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Consulta> eventosDelDia(DateTime day, List<Consulta> consultas) {
    return consultas.where((consulta) {
      return isSameDay(convertirFecha(consulta.fecha), day);
    }).toList();
  }
  ...
  Future<void> cargarNombre() async {
    final nombre = await FirebaseService.obtenerNombre();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                consultasDelDia.isEmpty
                    ? const Center(child: Text("Seleccione una fecha"))
                    : Column(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        elevation: 8,
        onPressed: () {
          Navigator.pushNamed(context, '/NuevaConsulta');
        },
